//
//  InterestCollectionViewLayout.m
//  Ace
//
...
#import "InterestCollectionViewLayout.h"

@interface InterestCollectionViewLayout ()
...
@implementation InterestCollectionViewLayout
...
-(void)prepareLayout
{
    ...
    for (NSUInteger index = 0; index < numberOfItems; index++)
    {
        ...
        itemSize = CGSizeMake(self.collectionView.bounds.size.width*0.5-_itemOffset.horizontal-(_itemOffset.horizontal/2), self.collectionView.bounds.size.width*0.5-_itemOffset.horizontal-(_itemOffset.horizontal/2));
        ...
        if (column == numberOfColumnsInRow)
        {
            ...
            numberOfColumnsInRow = 2;//arc4random() % 6+3;
        }
    }
