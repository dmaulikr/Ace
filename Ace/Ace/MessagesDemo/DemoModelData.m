...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.outgoingBubbleImageData = [bubbleFactory outgoingMessagesBubbleImageWithColor:[UIColor colorFromHexString:@"DF31A7"]];
        self.incomingBubbleImageData = [bubbleFactory incomingMessagesBubbleImageWithColor:[UIColor colorFromHexString:@"6A6A6A"]];
    }
